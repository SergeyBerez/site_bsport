...
export default function Index() {
  ...
  return (
    <>
      <Head>
        {" "}
        <title>Чоловічі спортивні костюми оптом</title>
        <meta
          name="description"
          content="Чоловічі спортивні костюми оптом від виробника купити в інтернет магазині ➔ . У нас: ✓ великий вибір чоловічих спортивних штанів оптом, ✔ високий рівень сервісу ₴ самі низькі ціни і ✈ доставка по всій Україні: Хмельницький, Одеса, Київ."
        />
        <meta
          name="keywords"
